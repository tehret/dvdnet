...
class DVDnet_spatial(nn.Module):
    ...
    def __init__(self):
        ...
        self.downscale = nn.Unfold(
            kernel_size=self.down_kernel_size, stride=self.down_stride)
...
class DVDnet_temporal(nn.Module):
    ...
    def __init__(self, num_input_frames):
        ...
        self.num_input_channels = int(
            (num_input_frames + 1) * 3)  # num_input_frames RGB frames + noisemap
            ...
            nn.Conv2d(in_channels=self.num_feature_maps,
                      ...
                      bias=False),
                                                                        ...
                                                                        nn.ReLU(
                                                                            inplace=True),
                                                                        nn.Conv2d(
                                                                            in_channels=self.num_feature_maps,
                                                                                out_channels=self.output_features,
                                                                                kernel_size=self.kernel_size,
                                                                                padding=self.padding,
                                                                                stride=self.stride,
